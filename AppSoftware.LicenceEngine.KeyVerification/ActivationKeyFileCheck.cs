...
namespace AppSoftware.LicenceEngine.KeyVerification
{
    ...
    internal /*public*/ class ActivationKeyFileCheck
    {
        ...
        public void CheckActivationKeyFile(string activationKeyFileFullPath,
            ...
            string friendlyApplicationName)
        {
            ...
            {
                throw new ActivationKeyFileNotPresentException("The product activation key file '" + activationKeyFileFullPath + "' was expected at '"
                    + activationKeyFileFullPath + "', but was not found. Please visit the vendor website to obtain a product activation key file.");
            }
